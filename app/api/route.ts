...
`;
    ...
    console.log("AI raw response:", raw); // <-- Add this for debugging
    ...
    if (!Array.isArray(evaluations) || evaluations.length === 0) {
      console.error("Evaluations array is empty or invalid:", evaluations);
      return NextResponse.json(
        { error: "AI did not return valid evaluations." },
        { status: 500 }
      );
    }
